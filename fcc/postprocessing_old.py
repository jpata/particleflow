...
def get_cluster_subdet_energies(hit_list, hit_data, collectionIDs_reverse, iev):
    """
    This function calculates the energy contribution from each of four subdetectors in a particle physics experiment,
    based on a list of hits and their corresponding data.
    Args:
