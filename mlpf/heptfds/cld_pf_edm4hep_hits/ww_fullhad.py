...
_DESCRIPTION = """
CLD EDM4HEP dataset with ee -> WW at 365 GeV, using hit-level information.
...
class CldEdmWwFullhadHits(tfds.core.GeneratorBasedBuilder):
    VERSION = tfds.core.Version(os.environ.get("TFDS_VERSION", "1.0.0"))
    RELEASE_NOTES = {
        "1.0.0": "Initial hit-level version",
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(CldEdmWwFullhadHits, self).__init__(*args, **kwargs)
