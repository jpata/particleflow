...
_DESCRIPTION = """
CLD EDM4HEP dataset with ee -> qq at 365 GeV, using hit-level information.
...
class CldEdmQqHits(tfds.core.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(CldEdmQqHits, self).__init__(*args, **kwargs)
