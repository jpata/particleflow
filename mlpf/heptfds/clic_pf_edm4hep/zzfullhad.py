...
_DESCRIPTION = """
CLIC EDM4HEP dataset with ZZ->fullhadronic
"""
...
class ClicEdmZzFullhadPf(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        return split_sample(Path("data/p8_ee_ZZ_fullhad_ecm365/"))
