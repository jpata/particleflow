...
_DESCRIPTION = """
CLIC EDM4HEP dataset with ee -> ttbar at 380 GeV, using hit-level information.
...
class ClicEdmTtbarHits(tfds.core.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(ClicEdmTtbarHits, self).__init__(*args, **kwargs)
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        return split_sample(Path(path / "p8_ee_ttbar_ecm380"), self.builder_config, num_splits=NUM_SPLITS, dataset=Dataset.CLIC_HITS)
