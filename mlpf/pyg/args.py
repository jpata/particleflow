...
def parse_args():
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="../data/delphes/pythia8_ttbar",
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="number of data files to use for training.. each file contains 100 events",
    )
    parser.add_argument(
        "--n_valid",
        type=int,
        default=1,
        help="number of data files to use for validation.. each file contains 100 events",
    )
    parser.add_argument(
        "--n_test",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="Which epoch of the model to load for evaluation",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=126,
        help="hidden dimension of layers before the graph convolutions",
    )
    parser.add_argument(
        "--hidden_dim2",
        type=int,
        default=256,
        help="hidden dimension of layers after the graph convolutions",
    )
    parser.add_argument(
        "--embedding_dim",
        type=int,
    ...
    parser.add_argument(
        ...
        dest="make_plots",
        action="store_true",
        help="makes plots of the test predictions",
    )
