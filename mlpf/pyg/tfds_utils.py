...
class Dataset:
    ...
    def get_loader(self, world_size, batch_size=20, num_workers=2, prefetch_factor=4):
        if world_size > 1:
            return DataLoader(
                self.ds,
...
class DataLoader(torch.utils.data.DataLoader):
    ...
    def __init__(
        self,
        dataset: Union[torch_geometric.data.Dataset, Sequence[BaseData], DatasetAdapter],
        batch_size: int = 1,
        shuffle: bool = False,
