...
#    ("TTbar_14TeV_TuneCUETP8M1_cfi",                           700000, 700010, "genjob_nopu.sh", outdir + "/nopu"),
...
#    ("SingleElectronFlatPt1To1000_pythia8_cfi",                900000, 900010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SingleGammaFlatPt1To1000_pythia8_cfi",                  1000000,1000010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SingleMuFlatPt1To1000_pythia8_cfi",                     1100000,1100010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SingleNeutronFlatPt0p7To1000_cfi",                      1200000,1200010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SinglePi0Pt1To1000_pythia8_cfi",                        1300000,1300010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SinglePiMinusFlatPt0p7To1000_cfi",                      1400000,1400010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SingleProtonMinusFlatPt0p7To1000_cfi",                  1500000,1500010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SingleTauFlatPt1To1000_cfi",                            1600000,1600010, "genjob_nopu.sh", outdir + "/nopu"),
#    ("SingleK0FlatPt1To1000_pythia8_cfi",                     1700000,1700010, "genjob_nopu.sh", outdir + "/nopu"),
]
