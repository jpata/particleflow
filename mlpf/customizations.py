...
def customize_pipeline_test(config):
    ...
    if "clic_ttbar_pf" in config["datasets"]:
        ...
        config["evaluation_datasets"] = {
            "clic_ttbar_pf": {"batch_size": 50, "num_events": -1}
        }
