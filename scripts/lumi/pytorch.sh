...
singularity exec --rocm \
    ...
    --data-dir $TFDS_DATA_DIR --config parameters/pyg-cms-small.yaml \
    --train --conv-type gnn_lsh --num-epochs 20 --gpu-batch-multiplier 4 --num-workers 1 --prefetch-factor 10
