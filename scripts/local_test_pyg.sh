...
python mlpf/pyg_pipeline.py --config parameters/pyg-workflow-test.yaml --dataset cms --data_dir ./tensorflow_datasets/ --prefix MLPF_test_ --ntrain 2 --ntest 2 --nvalid 1 --gpus "" --train --test --make_plots
