...
# for ifile in $(seq 1 $END); do
#     sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpfpu scripts/tallinn/ttbar_pu_13p6.txt TTbar_PU $ifile
#     sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False pf scripts/tallinn/ttbar_pu_13p6.txt TTbar_PU $ifile
# done
#
