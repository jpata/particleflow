...
# for ifile in $(seq 1 $END); do
#     sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpfpu scripts/tallinn/photonjet_pu_13p6.txt PhotonJet_13p6 $ifile
#     sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False pf scripts/tallinn/photonjet_pu_13p6.txt PhotonJet_13p6 $ifile
# done
#
...
#for ifile in $(seq 1 $END); do
#    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpfpu scripts/tallinn/ttbar_nopu_13p6.txt TTbar_noPU_13p6_v2 $ifile
#    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False pf scripts/tallinn/ttbar_nopu_13p6.txt TTbar_noPU_13p6_v2 $ifile
#done
