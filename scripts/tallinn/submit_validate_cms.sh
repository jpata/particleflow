...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job_data.sh False mlpf scripts/tallinn/jetmet0.txt JetMET0 $ifile
...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpf scripts/tallinn/photonjet_pu_13p6.txt PhotonJet_PU_13p6 $ifile
...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpf scripts/tallinn/photonjet_nopu_13p6.txt PhotonJet_noPU_13p6 $ifile
...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpf scripts/tallinn/ttbar_pu.txt TTbar_PU $ifile
...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpf scripts/tallinn/ttbar_pu_13p6.txt TTbar_PU_13p6 $ifile
...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpf scripts/tallinn/ttbar_nopu_13p6.txt TTbar_noPU_13p6 $ifile
...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpf scripts/tallinn/qcd_pu.txt QCD_PU $ifile
...
for ifile in $(seq 1 $END); do
    sbatch $SUBSCRIPT scripts/cmssw/validation_job.sh False mlpf scripts/tallinn/qcd_nopu_13p6.txt QCD_noPU_13p6 $ifile
