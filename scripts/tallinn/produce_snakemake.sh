...
singularity exec -B /local --env PYTHONPATH=`pwd` /home/software/singularity/pytorch.simg\:2026-02-04 python3 mlpf/data/cms/produce_snakemake.py --production $WORKFLOW --steps gen,post,tfds
...
singularity exec -B /local --env PYTHONPATH=`pwd` /home/software/singularity/pytorch.simg\:2026-02-04 python3 mlpf/data/cms/produce_snakemake.py --production $WORKFLOW --steps train --model $MODEL
