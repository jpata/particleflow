...
#SBATCH --job-name=train-dedicated-hits
#SBATCH --array=0-1
...
TRAINSET=${TRAINSETS[$SLURM_ARRAY_TASK_ID]}
...
MIXED_DATA_DIR=${MIXED_DATA_DIR:-${TMPDIR:-/tmp}/particleflow_dedicated_hits_tfds_${SLURM_JOB_ID}}
