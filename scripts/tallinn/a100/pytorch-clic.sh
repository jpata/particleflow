...
singularity exec -B /scratch/persistent --nv \
    ...
    --train --test --make-plots --conv-type attention --num-epochs 20 --gpu-batch-multiplier 128 --num-workers 4 --prefetch-factor 100 --checkpoint-freq 1 --comet --attention-type math --ntrain 50000 --nvalid 1000 --ntest 1000
