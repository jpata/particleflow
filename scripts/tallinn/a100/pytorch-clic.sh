...
singularity exec -B /scratch/persistent --nv \
    ...
    --gpu-batch-multiplier 256 --checkpoint-freq 1 --num-workers 8 --prefetch-factor 100 --comet --ntest 2000 --test-datasets clic_edm_qq_pf --load experiments/pyg-clic_20250106_193536_269746/checkpoints/checkpoint-01-2.431203.pth
