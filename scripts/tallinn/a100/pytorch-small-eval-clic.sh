...
singularity exec -B /scratch/persistent --nv \
     ...
     --test --make-plots --gpu-batch-multiplier 100 --load $WEIGHTS --dtype bfloat16 --prefetch-factor 10 --num-workers 8 --load experiments/pyg-clic_20240928_174207_681758/checkpoints/checkpoint-05-3.841247.pth --ntest 10000
