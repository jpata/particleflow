...
singularity exec -B /scratch/persistent --nv \
     ...
     --test --make-plots --gpu-batch-multiplier 100 --load $WEIGHTS --dtype bfloat16 --prefetch-factor 10 --num-workers 8 --load experiments/pyg-clic_20240930_165236_913257/checkpoints/checkpoint-02-2.324376.pth --ntest 10000
