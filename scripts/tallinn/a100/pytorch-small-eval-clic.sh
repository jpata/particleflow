...
WEIGHTS=experiments/pyg-clic_20240817_094937_480662/checkpoints/checkpoint-03-7.261744.pth
singularity exec -B /scratch/persistent --nv \
     ...
     --test --make-plots --gpu-batch-multiplier 100 --load $WEIGHTS --dtype bfloat16 --ntest 50000
