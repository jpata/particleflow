...
WEIGHTS=experiments/pyg-clic_20240807_134034_168101/checkpoints/checkpoint-100-9.413720.pth
singularity exec -B /scratch/persistent --nv \
     ...
     --test --make-plots --gpu-batch-multiplier 200 --load $WEIGHTS --dtype bfloat16
