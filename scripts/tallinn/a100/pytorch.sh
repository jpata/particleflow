...
singularity exec -B /scratch/persistent --nv \
    ...
    --train --conv-type attention --num-epochs 50 --gpu-batch-multiplier 80 --num-workers 2 --prefetch-factor 20 --checkpoint-freq 1 --lr 0.00001 --load experiments/pyg-cms_20240210_013116_879112/sub1/best_weights.pth
