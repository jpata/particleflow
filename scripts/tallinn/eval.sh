...
./scripts/tallinn/wrapper.sh python mlpf/pipeline.py --spec-file particleflow_spec.yaml --model-name pyg-cld-hits-v1 --production cld --data-dir $DATA_DIR --prefix plots_ test --load experiments/pyg-cld-hits-v1_cld_20260323_132139_857098/checkpoints/checkpoint-100000.pth --make_plots True --ntest 1000
