...
# https://huggingface.co/datasets/jpata/particleflow/tree/main/root/cld/ttbar
...
wget -q --no-check-certificate -nc https://huggingface.co/datasets/jpata/particleflow/resolve/main/root/cld/ttbar/reco_p8_ee_ttbar_ecm365_300000.root
wget -q --no-check-certificate -nc https://huggingface.co/datasets/jpata/particleflow/resolve/main/root/cld/ttbar/reco_p8_ee_ttbar_ecm365_300001.root
popd > /dev/null
