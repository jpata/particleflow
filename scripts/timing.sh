...
$CMD_CPU --model $MODELS/mlpf_5M_attn2x3x256_bm5_relu_checkpoint8_pudisc_1xa100_fp32_unfused.onnx --num-threads 1 | tee timing/cpu_fp32_unfused.txt
$CMD_CPU --model $MODELS/mlpf_5M_attn2x3x256_bm5_relu_checkpoint8_pudisc_1xa100_fp32_fused.onnx --num-threads 1 | tee timing/cpu_fp32_fused.txt
