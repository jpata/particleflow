...
python mlpf/pipeline.py train --config parameters/tensorflow/cms.yaml --nepochs 1 --customize pipeline_test
...
python mlpf/pipeline.py train --config parameters/tensorflow/cms.yaml --nepochs 1 --customize pipeline_test --weights ./experiments/cms*/weights/weights-01-*.hdf5
