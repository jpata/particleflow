...
papermill --inject-output-path --log-output -p ncores 1 -p path ./experiments/cms*/evaluation/epoch_2/cms_pf_ttbar/ notebooks/cms-mlpf.ipynb out.ipynb &> cms-mlpf.log
