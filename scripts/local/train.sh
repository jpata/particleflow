...
./scripts/local/wrapper.sh python3 mlpf/standalone/eval.py --data-dir $DATA_DIR --dsl "i(55,128,256,default)|f(16,128,512)*4|o(8,256,default)" --show-attention > log_fast.txt
