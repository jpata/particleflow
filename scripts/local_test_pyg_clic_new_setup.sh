...
for sample in ../../data/clic_edm4hep_2023_02_27/* ; do
  ...
  python3 PFGraphDataset.py --data CLIC_new --dataset $sample \
...
cd ../
python ssl_pipeline.py --dataset CLIC_new --data_path ../data/clic_edm4hep_2023_02_27/ --data_split_mode mix --prefix_VICReg VICReg_test --n_epochs_VICReg=0 --prefix MLPF_test --num_convs=0 --train_mlpf --native
