...
CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 singularity exec -B /storage --nv ~jpata/gpuservers/singularity/images/pytorch.simg \
  python3 test/tf_model.py --target cand --ntrain 400000 --ntest 100000 --nepochs 1000 --lr 0.00001 \
