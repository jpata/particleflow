...
if __name__ == "__main__":
    ...
    #output_saved_model_dir = "model_trt"
    #params = trt.DEFAULT_TRT_CONVERSION_PARAMS
    #params = params._replace(max_workspace_size_bytes=4000000000)
    #params = params._replace(precision_mode="FP32")
    #params = params._replace(maximum_cached_engines=100)
    ##params = params._replace(is_dynamic_op=True)
    #params = params._replace(minimum_segment_size=1)
