...
echo "Building TFDS for mlpf/heptfds/cld_pf_edm4hep_hits/qq config $config_id"
...
tfds build mlpf/heptfds/cld_pf_edm4hep_hits/qq --config $config_id --data_dir $job_scratch_dir --manual_dir /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/post --overwrite
