...
for (( i=0; i<1; i++ )); do
    ...
    if [ ! -f /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/gen/p8_ee_WW_fullhad_ecm365/root/reco_p8_ee_WW_fullhad_ecm365_${seed}.root ]; then
        ...
        echo "Validating /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/gen/p8_ee_WW_fullhad_ecm365/root/reco_p8_ee_WW_fullhad_ecm365_${seed}.root"
        python3 -c "import uproot; uproot.open('/local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/gen/p8_ee_WW_fullhad_ecm365/root/reco_p8_ee_WW_fullhad_ecm365_${seed}.root')"
    else
