...
for (( i=0; i<1; i++ )); do
    ...
    if [ ! -f /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/gen/p8_ee_WW_fullhad_ecm365/root/reco_p8_ee_WW_fullhad_ecm365_${seed}.root ]; then
        ...
        export OUTDIR=/local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/gen/ && export CONFIG_DIR=/home/joosep/particleflow-dev/mlpf/data/key4hep/gen/cld/CLDConfig && export WORKDIR="/scratch/local/joosep/p8_ee_WW_fullhad_ecm365_${seed}_${SLURM_JOB_ID:-manual-$$}" && export NEV=100
