...
for (( i=0; i<1; i++ )); do
    ...
    if [ ! -f /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/post/p8_ee_ttbar_ecm365/reco_p8_ee_ttbar_ecm365_${seed}.parquet ]; then
        if [ -f /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/gen/p8_ee_ttbar_ecm365/root/reco_p8_ee_ttbar_ecm365_${seed}.root ]; then
            ...
            python3 mlpf/data/key4hep/postprocessing.py --input /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/gen/p8_ee_ttbar_ecm365/root/reco_p8_ee_ttbar_ecm365_${seed}.root --outpath /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/post/p8_ee_ttbar_ecm365
            if [ -f /local/joosep/mlpf/cld/v1.2.5_key4hep_2025-05-29/post/p8_ee_ttbar_ecm365/reco_p8_ee_ttbar_ecm365_${seed}.parquet ]; then
