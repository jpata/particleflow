...
config_id=$1
tfds_id=qcd_nopu_tfds_$config_id
...
echo "Building TFDS for mlpf/heptfds/cms_pf/qcd_nopu config $config_id"
...
tfds build mlpf/heptfds/cms_pf/qcd_nopu --config $config_id --data_dir $job_scratch_dir --manual_dir /local/joosep/mlpf/cms/20260204_cmssw_15_0_5_117d32/post/nopu --overwrite
