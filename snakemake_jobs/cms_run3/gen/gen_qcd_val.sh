...
for (( i=0; i<1; i++ )); do
    ...
    if [ ! -f /local/joosep/mlpf/cms/20260204_cmssw_15_0_5_117d32/gen/pu55to75_val/QCDForPF_13p6TeV_TuneCUETP8M1_cfi/root/pfntuple_${seed}.root ]; then
        ...
        export OUTDIR=/local/joosep/mlpf/cms/20260204_cmssw_15_0_5_117d32/gen/pu55to75_val/ && export CONFIG_DIR=/home/joosep/particleflow2 && export CMSSWDIR=/scratch/persistent/joosep/CMSSW_15_0_5 && export WORKDIR=/scratch/local/joosep/QCDForPF_13p6TeV_TuneCUETP8M1_cfi_$seed && export NEV=100
