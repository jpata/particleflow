...
echo "Building TFDS for mlpf/heptfds/clic_pf_edm4hep/ww_fullhad config $config_id"
...
tfds build mlpf/heptfds/clic_pf_edm4hep/ww_fullhad --config $config_id --data_dir $job_scratch_dir --manual_dir /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/post --overwrite
