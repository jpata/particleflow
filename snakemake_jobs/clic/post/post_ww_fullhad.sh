    ...
    if [ ! -f /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/post/p8_ee_WW_fullhad_ecm380/reco_p8_ee_WW_fullhad_ecm380_${seed}.parquet ]; then
        if [ -f /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/gen/p8_ee_WW_fullhad_ecm380/root/reco_p8_ee_WW_fullhad_ecm380_${seed}.root ]; then
            ...
            if [ -f /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/post/p8_ee_WW_fullhad_ecm380/reco_p8_ee_WW_fullhad_ecm380_${seed}.parquet ]; then
                ...
                echo "Error: Postprocessing failed to produce /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/post/p8_ee_WW_fullhad_ecm380/reco_p8_ee_WW_fullhad_ecm380_${seed}.parquet"
                exit 1
            fi
        else
            echo "Error: Input file /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/gen/p8_ee_WW_fullhad_ecm380/root/reco_p8_ee_WW_fullhad_ecm380_${seed}.root missing for postprocessing"
            exit 1
        fi
    else
        echo "Skipping /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/post/p8_ee_WW_fullhad_ecm380/reco_p8_ee_WW_fullhad_ecm380_${seed}.parquet, already exists"
    fi
