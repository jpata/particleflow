...
config_id=$1
tfds_id=ww_fullhad_tfds_hit_$config_id
job_scratch_dir=/scratch/local/joosep/tfds_tmp/$tfds_id

export PYTHONPATH=$(pwd):$PYTHONPATH
export KERAS_BACKEND=torch
hostname
export TFDS_VERSION=3.2.1
env

echo "Building TFDS for mlpf/heptfds/clic_pf_edm4hep_hits/ww_fullhad config $config_id"
...
tfds build mlpf/heptfds/clic_pf_edm4hep_hits/ww_fullhad --config $config_id --data_dir $job_scratch_dir --manual_dir /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/post --overwrite
