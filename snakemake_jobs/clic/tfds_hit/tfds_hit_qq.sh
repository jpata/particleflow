...
config_id=$1
tfds_id=qq_tfds_hit_$config_id
...
echo "Building TFDS for mlpf/heptfds/clic_pf_edm4hep_hits/qq config $config_id"
...
tfds build mlpf/heptfds/clic_pf_edm4hep_hits/qq --config $config_id --data_dir $job_scratch_dir --manual_dir /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/post --overwrite
