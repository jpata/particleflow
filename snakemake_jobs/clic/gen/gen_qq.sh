...
for (( i=0; i<1; i++ )); do
    ...
    if [ ! -f /local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/gen/p8_ee_qq_ecm380/root/reco_p8_ee_qq_ecm380_${seed}.root ]; then
        ...
        export OUTDIR=/local/joosep/mlpf/clic/v1.2.5_key4hep_2025-05-29/gen/ && export CONFIG_DIR=/home/joosep/particleflow/mlpf/data/key4hep/gen/clic && export WORKDIR="/scratch/local/joosep/p8_ee_qq_ecm380_${seed}_${SLURM_JOB_ID:-manual-$$}" && export NEV=100
