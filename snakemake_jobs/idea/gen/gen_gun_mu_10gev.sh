...
for (( i=0; i<1; i++ )); do
    ...
    if [ ! -f /local/joosep/mlpf/idea/IDEA_o1_v03_fccconfig_a05a3a9/gen/gun_mu_10gev/root/reco_gun_mu_10gev_${seed}.root ]; then
        ...
        export OUTDIR=/local/joosep/mlpf/idea/IDEA_o1_v03_fccconfig_a05a3a9/gen/ && export CONFIG_DIR=/home/joosep/particleflow/mlpf/data/key4hep/gen/idea && export WORKDIR="/scratch/local/joosep/gun_mu_10gev_${seed}_${SLURM_JOB_ID:-manual-$$}" && export NEV=100 && export PROGRESS_INTERVAL=60
