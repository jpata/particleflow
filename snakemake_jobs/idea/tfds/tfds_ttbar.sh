...
echo "Building TFDS for mlpf/heptfds/idea_pf_edm4hep/ttbar config $config_id"
...
tfds build mlpf/heptfds/idea_pf_edm4hep/ttbar --config $config_id --data_dir $job_scratch_dir --manual_dir /local/joosep/mlpf/idea/IDEA_o1_v03_fccconfig_a05a3a9/post --overwrite
